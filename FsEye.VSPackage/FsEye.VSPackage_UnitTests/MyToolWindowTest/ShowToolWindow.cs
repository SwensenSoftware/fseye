...
using StephenSwensen.FsEye_VSPackage;

namespace FsEye.VSPackage_UnitTests.MyToolWindowTest {
    [TestClass()]
    public class ShowToolWindowTest {

        [TestMethod()]
        public void ValidateToolWindowShown() {
            IVsPackage package = new FsEye_VSPackagePackage() as IVsPackage;
            ...
            MethodInfo method = typeof(FsEye_VSPackagePackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
